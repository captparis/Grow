class GFxGrowView extends GFxObject
	dependson(WorldInfo);

`include(GWOnlineConstants.uci)
/**
...
final function GWPlayerController GetGWPlayerOwner(optional int PlayerIndex=-1)
{
    return GWPlayerController(Outer.GetPC());
}
